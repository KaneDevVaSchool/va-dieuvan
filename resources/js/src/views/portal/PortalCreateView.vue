<template>
    <div
        ...
        :aria-label="
            form.is_urgent && !loading
                ? t('dispatch_wizard.create.form_priority_frame_aria')
                : undefined
        "
    >
        <!-- Header -->
        ...
        >
            <div>
                <p
                    class="text-xs font-semibold uppercase tracking-wide text-va-800"
                >
                    {{ t("portal.nav_title") }}
                </p>
                <h1
                ...
                <p
                    v-if="form.is_urgent"
                    class="mt-2 inline-flex flex-wrap items-center gap-2 text-sm text-rose-700"
                >
                    <span
                    ...
                    <span
                        ...
                        >{{ t("dispatch_wizard.create.urgent") }}</span
                    >
                </p>
            </div>
            <div class="flex flex-col items-stretch gap-2 sm:items-end">
                <div class="flex flex-wrap items-center justify-end gap-2">
                    ...
                    <div ref="draftMenuEl" class="relative">
                        <button
                            ...
                            :class="{
                                'border-slate-300 bg-slate-50': draftMenuOpen,
                            }"
                        ...
                        >
                            ...
                            >
                                <BookmarkIcon
                                    class="h-4 w-4 shrink-0 text-va-600"
                                />
                            ...
                            <template v-if="activeDraftId">
                                ...
                                <button
                                    ...
                                    @click="
                                        draftMenuAction(openClearDraftModal)
                                    "
                                >
                                    <TrashIcon
                ...
                <p
                    v-if="draftSaveError"
                    class="text-xs font-medium text-rose-600 sm:text-right"
                >
                    {{ draftSaveError }}
                </p>
            </div>
        ...
        <div>
            ...
            <section class="dw-portal-surface">
                ...
                <div v-show="step === 1" class="dw-portal-step2">
                    ...
                    >
                        <p class="dw-portal-panel-title">
                            {{ t("dispatch_wizard.create.sec_requester") }}
                        </p>

                        <div class="relative">
                            <label class="dw-label">
                                <span>{{
                                    t("dispatch_wizard.create.search_by_name")
                                }}</span>
                                <span
                                    class="inline-flex cursor-help text-slate-400 hover:text-slate-600"
                                    :title="
                                        t(
                                            'dispatch_wizard.create.search_name_hint',
                                        )
                                    "
                                >
                            ...
                            <input
                                ...
                                :aria-expanded="
                                    ...
                                    requesterSearchQ.trim().length >= 2
                                "
                                aria-controls="dw-requester-search-list"
                                :placeholder="
                                    t('dispatch_wizard.create.search_ph')
                                "
                                class="dw-input"
                            ...
                            >
                                <li
                                    v-if="requesterSearchLoading"
                                    class="dw-combobox__empty"
                                >
                                    {{ t("dispatch_wizard.create.searching") }}
                                </li>
                                <template
                                    v-else-if="requesterSearchResults.length"
                                >
                                    <li
                                        v-for="u in requesterSearchResults"
                                        :key="u.id"
                                    >
                                        <button
                                            type="button"
                                ...
                                <li v-else class="dw-combobox__empty">
                                    {{ t("dispatch_wizard.create.no_staff") }}
                                </li>
                            </ul>
                            <p
                                v-if="requesterSearchError"
                        ...
                        <label class="block">
                            <span class="dw-label-text"
                                >{{ t("dispatch_wizard.create.full_name") }}
                                <span class="dw-req" aria-hidden="true"
                                    >*</span
                                ></span
                            >
                            <input
                                ...
                                class="dw-input mt-1"
                                :placeholder="
                                    t('dispatch_wizard.create.full_name_ph')
                                "
                            />
                        </label>
                        ...
                        <div class="dw-form-grid-2">
                            <div>
                                <label class="block">
                                    <span class="dw-label-text"
                                        >{{
                                            t(
                                                "dispatch_wizard.create.requester_email_label",
                                            )
                                        }}
                                        <span class="dw-req" aria-hidden="true"
                                            >*</span
                                    ...
                                    <input
                                        ...
                                        :placeholder="
                                            t(
                                                'dispatch_wizard.create.requester_email_ph',
                                            )
                                        "
                                        :class="[
                                            'dw-input mt-1',
                                ...
                                >
                                    {{
                                        t(
                                            "dispatch_wizard.create.email_invalid",
                                        )
                                    }}
                                </p>
                            </div>
                            <label class="block">
                                <span class="dw-label-text">{{
                                    t("dispatch_wizard.create.phone")
                                }}</span>
                                <input
                                    ...
                                    autocomplete="tel"
                                    :placeholder="
                                        t('dispatch_wizard.create.phone_ph')
                                    "
                                    class="dw-input mt-1"
                                    maxlength="11"
                        ...
                        <label class="block">
                            <span class="dw-label-text">{{
                                t("dispatch_wizard.create.unit")
                            }}</span>
                            <input
                                v-model="form.requester_unit"
                                type="text"
                                :placeholder="
                                    t('dispatch_wizard.create.unit_ph')
                                "
                                class="dw-input mt-1"
                            />
                        </label>
                    ...
                    >
                        <p class="dw-portal-panel-title">
                            {{ t("dispatch_wizard.create.sec_time") }}
                        </p>
                        ...
                        <div class="dw-form-grid-2">
                            <label class="block">
                                <span
                                    ...
                                    :title="
                                        t(
                                            'dispatch_wizard.create.proposed_date_title',
                                        )
                                    "
                                >
                                    {{
                                        t(
                                            "dispatch_wizard.create.proposed_date",
                                        )
                                    }}
                                    <span class="dw-req" aria-hidden="true"
                                        >*</span
                            ...
                            <label class="block">
                                <span
                                    ...
                                    :title="
                                        t(
                                            'dispatch_wizard.create.date_needed_title',
                                        )
                                    "
                                >
                                    {{
                                        t("dispatch_wizard.create.date_needed")
                                    }}
                                    <span class="dw-req" aria-hidden="true"
                                        >*</span
                                    >
                        ...
                        >
                            ...
                            >
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        ...
                                        :title="
                                            t(
                                                'dispatch_wizard.create.urgent_title',
                                            )
                                        "
                                    >
                                        <InformationCircleIcon
                                ...
                                <button
                                    ...
                                    :class="
                                        form.is_urgent
                                            ? 'justify-end bg-va-800'
                                            : 'justify-start bg-slate-300'
                                    "
                                    @click="toggleUrgentManual"
                                >
                                    <span
                                        class="pointer-events-none h-7 w-7 rounded-full bg-white shadow-sm ring-1 ring-black/5"
                                    />
                                </button>
                            </div>
                            ...
                            <div v-show="form.is_urgent" class="mt-3">
                                <label class="block">
                                    <span class="dw-label-text"
                                        >{{
                                            t("dispatch_wizard.create.reason")
                                        }}
                                        <span class="dw-req" aria-hidden="true"
                                            >*</span
                                        ></span
                                    ...
                                    <textarea
                                        ...
                                        :placeholder="
                                            t(
                                                'dispatch_wizard.create.reason_ph',
                                            )
                                        "
                            ...
                            <!-- Banner auto-urgent -->
                            <p
                                v-if="urgentAutoActive"
                                class="mt-3 rounded-lg bg-rose-50 px-3 py-2 text-xs font-medium leading-relaxed text-rose-800 ring-1 ring-rose-100"
                            >
                                {{
                                    t(
                                        "dispatch_wizard.create.urgent_auto_banner",
                                        {
                        ...
                        <div v-if="portalNeedsDeptHead" class="relative">
                            <label class="dw-label" for="portal-dept-head">
                                <span
                                    >{{
                                        t(
                                            "request_detail.assign_dept_head_label",
                                        )
                                    }}
                                    <span class="dw-req" aria-hidden="true"
                                        >*</span
                                ...
                                <span
                                    ...
                                    :title="
                                        t(
                                            'portal.create.assign_dept_head_tooltip',
                                        )
                                    "
                                >
                                    <InformationCircleIcon
                            ...
                            <input
                                ...
                                :aria-expanded="
                                    ...
                                    deptHeadQ.trim().length >= 2
                                "
                                aria-controls="portal-dept-head-list"
                                :placeholder="
                                    t(
                                        'request_detail.assign_dept_head_combo_ph',
                                    )
                                "
                                :class="[
                                    'dw-input',
                            ...
                            >
                                ...
                                >
                                    {{
                                        t(
                                            "request_detail.assign_dept_head_loading",
                                        )
                                    }}
                                </li>
                                <template v-else-if="deptHeadResults.length">
                                    <li
                                        v-for="u in deptHeadResults"
                                        :key="u.id"
                                    >
                                        <button
                                            type="button"
                                ...
                                <li v-else class="dw-combobox__empty">
                                    {{
                                        t(
                                            "request_detail.assign_dept_head_no_match",
                                        )
                                    }}
                                </li>
                            </ul>
                            <p
                                v-if="deptHeadSearchError"
                                class="dw-field-error"
                            >
                                {{ deptHeadSearchError }}
                            </p>
                            <p
                                v-else-if="deptHeadClientError"
                                class="dw-field-error"
                            >
                                {{ deptHeadClientError }}
                            </p>
                            <p v-else class="dw-field-hint">
                                {{
                                    t(
                                        "request_detail.assign_dept_head_combo_hint",
                                    )
                                }}
                            </p>
                        </div>
                    ...
                    >
                        <p class="dw-portal-panel-title">
                            {{ t("dispatch_wizard.create.sec_purpose") }}
                        </p>
                        <div
                        ...
                        <label class="block">
                            <span class="dw-label-text"
                                >{{ t("dispatch_wizard.create.purpose_label") }}
                                <span class="dw-req" aria-hidden="true"
                                    >*</span
                                ></span
                            >
                            <textarea
                                ...
                                :placeholder="
                                    t('dispatch_wizard.create.purpose_ph')
                                "
                            />
                        </label>
                        <div>
                            <span
                                class="mb-1.5 flex flex-nowrap items-center gap-1.5"
                            >
                                <span class="dw-label-text mb-0">{{
                                    t("dispatch_wizard.create.basis_label")
                                }}</span>
                                <span
                                    class="inline-flex shrink-0 cursor-help text-slate-400 hover:text-slate-600"
                                    :title="
                                        t('dispatch_wizard.create.basis_title')
                                    "
                                >
                                    <InformationCircleIcon
                                        class="h-4 w-4"
                            ...
                            >
                                ...
                                />
                                <p
                                    class="mt-2 text-center text-sm font-medium text-slate-800"
                                >
                                    {{ t("dispatch_wizard.create.basis_drop") }}
                                </p>
                                <p
                                    class="mt-0.5 text-center text-xs text-slate-500"
                                >
                                    {{
                                        t("dispatch_wizard.create.basis_types")
                                    }}
                                </p>
                                <input
                                    ref="basisFileInput"
                            ...
                            <p v-if="basisFileError" class="dw-field-error">
                                {{ basisFileError }}
                            </p>
                            <div v-if="basisFile" class="dw-portal-file-row">
                                <PaperClipIcon
                                    class="h-5 w-5 shrink-0 text-va-800"
                                    aria-hidden="true"
                                />
                    ...
                    >
                        <div class="dw-portal-panel dw-form-stack">
                            ...
                            <div class="relative min-w-0">
                                <input
                                    ...
                                    :placeholder="
                                        t(
                                            'dispatch_wizard.create.targets_search_ph',
                                        )
                                    "
                            ...
                            <p v-if="form.targets.length" class="dw-field-hint">
                                {{
                                    t(
                                        "dispatch_wizard.create.targets_selected",
                                        { n: form.targets.length },
                                    )
                                }}
                            </p>
                            <p
                        ...
                        <div
                            v-if="showCoordinatorPanel"
                            class="dw-portal-panel dw-form-stack"
                        >
                            <p class="dw-portal-panel-title">
                                {{
                                    t("dispatch_wizard.create.sec_coordinator")
                                }}
                            </p>
                            ...
                            <div class="relative">
                                <label class="dw-label">
                                    <span>{{
                                        t(
                                            "dispatch_wizard.create.coord_search_label",
                                        )
                                    }}</span>
                                    <span
                                        class="inline-flex cursor-help text-slate-400 hover:text-slate-600"
                                        :title="
                                            t(
                                                'dispatch_wizard.create.coord_search_title',
                                            )
                                        "
                                    >
                                        <InformationCircleIcon
                                ...
                                <input
                                    ...
                                    :aria-expanded="
                                        ...
                                        coordinatorSearchQ.trim().length >= 2
                                    "
                                    aria-controls="dw-coordinator-search-list"
                                    :placeholder="
                                        t(
                                            'dispatch_wizard.create.coord_search_ph',
                                        )
                                    "
                                    class="dw-input"
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            t(
                                                "dispatch_wizard.create.searching",
                                            )
                                        }}
                                    </li>
                                    <template
                                        v-else-if="
                                            coordinatorSearchResults.length
                                        "
                                    >
                                        <li
                                            v-for="u in coordinatorSearchResults"
                                            :key="u.id"
                                        >
                                            <button
                                                type="button"
                            ...
                            <label class="block">
                                ...
                                <input
                                    ...
                                    :placeholder="
                                        t(
                                            'dispatch_wizard.create.coord_name_ph',
                                        )
                                    "
                                />
                            </label>
                            ...
                            <div class="dw-form-grid-2">
                                <div>
                                    <label class="block">
                                        <span class="dw-label-text">{{
                                            t(
                                                "dispatch_wizard.create.coord_email_label",
                                            )
                                        }}</span>
                                        <input
                                            ...
                                            :placeholder="
                                                t(
                                                    'dispatch_wizard.create.coord_email_ph',
                                                )
                                            "
                                    ...
                                    <p
                                        v-if="step2CoordinatorEmailInvalid"
                                        class="dw-field-error"
                                    >
                                        {{
                                            t(
                                                "dispatch_wizard.create.coord_email_invalid",
                                            )
                                        }}
                                    </p>
                                </div>
                                <label class="block">
                                    <span class="dw-label-text">{{
                                        t("dispatch_wizard.create.coord_phone")
                                    }}</span>
                                    <input
                                        ...
                                        :placeholder="
                                            t(
                                                'dispatch_wizard.create.coord_phone_ph',
                                            )
                                        "
                                        class="dw-input mt-1"
                                        maxlength="11"
    ...
    <Teleport to="body">
        ...
        >
            ...
            >
                ...
                >
                    <div
                        class="border-b border-slate-100 bg-gradient-to-br from-slate-50 via-white to-amber-50/30 px-5 pb-4 pt-5"
                    >
                        <div class="flex gap-4">
                            ...
                            <div class="min-w-0 pt-0.5">
                                <h3
                                    id="clear-draft-modal-title"
                                    class="text-base font-semibold leading-snug text-slate-900"
                                >
                                    {{
                                        t(
                                            "dispatch_wizard.create.clear_modal_title",
                                        )
                                    }}
                                </h3>
                                <p
                                ...
                                >
                                    {{
                                        t(
                                            "dispatch_wizard.create.clear_modal_body",
                                        )
                                    }}
                                </p>
                            </div>
                    ...
                    <div
                        class="flex flex-col-reverse gap-2 bg-slate-50/90 px-4 py-4 sm:flex-row sm:justify-end sm:gap-3"
                    >
                        <button
                            type="button"
                ...
                >
                    ...
                    >
                        <div class="flex gap-4">
                            ...
                            <div class="min-w-0 pt-0.5">
                                <h3
                                    id="submit-result-modal-title"
                                    class="text-base font-semibold leading-snug text-slate-900"
                                >
                                    {{
                                        submitResultOk
                                            ? t(
                                                  "dispatch_wizard.confirm.submit_modal_success_title",
                                              )
                                            : t(
                                                  "dispatch_wizard.confirm.submit_modal_fail_title",
                                              )
                                    }}
                                </h3>
                                <p
                                ...
                                >
                                    {{
                                        t(
                                            "dispatch_wizard.confirm.submit_modal_success_body",
                                            { id: created?.id ?? "—" },
                                        )
                                    }}
                                </p>
                                ...
                                >
                                    {{
                                        submitResultDetail ||
                                        t(
                                            "dispatch_wizard.confirm.submit_modal_fail_body",
                                        )
                                    }}
                                </p>
                                <p
                    ...
                    <div
                        class="flex flex-col gap-2 bg-slate-50/90 px-4 py-4 sm:flex-row sm:flex-wrap sm:justify-end sm:gap-3"
                    >
                        <template v-if="submitResultOk && created?.id">
                            ...
                            >
                                {{
                                    t(
                                        "dispatch_wizard.confirm.submit_modal_view_request",
                                    )
                                }}
                            </button>
                            <button
                            ...
                            >
                                {{
                                    t(
                                        "dispatch_wizard.confirm.submit_modal_new_request",
                                    )
                                }}
                            </button>
                        </template>
    ...
    <Teleport to="body">
        ...
        >
            ...
            >
                ...
                >
                    <div
                        class="shrink-0 border-b border-slate-100 bg-gradient-to-br from-slate-50 via-white to-sky-50/30 px-5 pb-4 pt-5"
                    >
                        <div
                        ...
                        >
                            <div class="min-w-0">
                                <h3
                                    id="drafts-library-title"
                                    class="text-base font-semibold leading-snug text-slate-900"
                                >
                                    {{
                                        t(
                                            "dispatch_wizard.create.library_title",
                                        )
                                    }}
                                </h3>
                                <p
                    ...
                    <div
                        class="min-h-0 flex-1 overflow-y-auto overscroll-y-contain px-3 py-3 sm:px-4"
                    >
                        <p
                            v-if="!savedDraftsList.length"
                            class="rounded-lg border border-dashed border-slate-200 bg-slate-50/80 px-4 py-8 text-center text-sm text-slate-600"
                        >
                            {{
                                t("dispatch_wizard.create.library_empty", {
                                    action: t(
                                        "dispatch_wizard.create.save_draft",
                                    ),
                                })
                            }}
                        </p>
                                ...
                                >
                                    <div class="min-w-0 flex-1">
                                        ...
                                        >
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "dispatch_wizard.create.library_active",
                                                    )
                                                }}
                                            </span>
                                        </div>
                                        <p
                                            class="mt-1 line-clamp-2 text-sm text-slate-800"
                                        >
                                            {{ d.purposeLine }}
                                        </p>
                                    ...
                                    >
                                        ...
                                        >
                                            {{
                                                t(
                                                    "dispatch_wizard.create.library_open",
                                                )
                                            }}
                                        </button>
                                        <button
                                        ...
                                        >
                                            {{
                                                t(
                                                    "dispatch_wizard.create.library_delete",
                                                )
                                            }}
                                        </button>
                                    </div>
                    ...
                    <div
                        class="border-t border-slate-100 bg-slate-50/90 px-4 py-3 sm:flex sm:justify-end"
                    >
                        <button
                            type="button"
    ...
    <Teleport to="body">
        ...
        >
            ...
            >
                ...
                >
                    <div
                        class="border-b border-slate-100 bg-gradient-to-br from-va-50 via-white to-slate-50/30 px-5 pb-4 pt-5"
                    >
                        <div class="flex items-center gap-3">
                            <span
                                class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-va-100 text-va-800"
                            >
                                <BookmarkIcon
                                    class="h-5 w-5"
                                    aria-hidden="true"
                    ...
                    <div
                        class="flex flex-col gap-2 border-t border-slate-100 bg-slate-50/90 px-5 py-3 sm:flex-row sm:justify-end sm:gap-3"
                    >
                        <button
                            type="button"
                        ...
                        <button
                            ...
                            :disabled="
                                !saveTemplateName.trim() || templateSaveLoading
                            "
        ...
        >
            ...
            >
                ...
                >
                    <!-- Header -->
                    <div
                        class="shrink-0 border-b border-slate-100 bg-gradient-to-br from-va-50 via-white to-slate-50/30 px-5 pb-4 pt-5"
                    >
                        <div
                            class="flex flex-wrap items-start justify-between gap-3"
                        >
                            <div class="flex min-w-0 items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-0.5 text-xs text-slate-500">
                                        {{ t("portal.template_library_hint") }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        >
                            <span
                                class="h-5 w-5 animate-spin rounded-full border-2 border-va-300 border-t-va-800"
                            />
                        </div>
                        <p
                                ...
                                <template v-if="templateRenameId === tmpl.id">
                                    <div class="flex items-center gap-2">
                                        <input
                                            ...
                                            :placeholder="
                                                t(
                                                    'portal.template_name_placeholder',
                                                )
                                            "
                                    ...
                                    >
                                        <div class="min-w-0 flex-1">
                                            ...
                                            >
                                                ...
                                                >
                                                <span
                                                    class="rounded-full bg-va-100 px-2 py-0.5 text-xs font-medium text-va-900"
                                                >
                                                    {{
                                                        TRIP_TYPE_LABELS[
                                                            tmpl.trip_type
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                :title="
                                                    t(
                                                        'portal.template_delete_confirm',
                                                    )
                                                "
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div class="mt-4 border-t border-slate-100 pt-4">
                            <label
                                ...
                                for="dw-target-custom-input"
                            >
                                {{
                                    t(
                                        "dispatch_wizard.create.targets_add_custom",
                                    )
                                }}
                            </label>
                            <div class="flex gap-2">
                                <input
                                    ...
                                    :placeholder="
                                        t(
                                            'dispatch_wizard.create.targets_custom_ph',
                                        )
                                    "
                                    maxlength="100"
                    ...
                    <div
                        class="border-t border-slate-100 bg-slate-50/90 px-4 py-3 sm:flex sm:items-center sm:justify-between sm:gap-3"
                    >
                        <p
                            v-if="form.targets.length"
                            class="mb-2 text-xs text-slate-600 sm:mb-0"
                        >
                            {{
                                t("dispatch_wizard.create.targets_selected", {
                                    n: form.targets.length,
                                })
                            }}
                        </p>
...
function onDocClick(e) {
    if (draftMenuEl.value && !draftMenuEl.value.contains(e.target))
...
const showCoordinatorPanel = computed(() =>
...
const portalCanGoNext = computed(() => {
    ...
    if (step2SubIndex.value === STEP2_SUB_IDS.length - 1)
...
const targetModalOptions = computed(() => {
    ...
    return targetOptions.filter((opt) =>
        normalizeTargetSearch(opt).includes(q),
    );
});
