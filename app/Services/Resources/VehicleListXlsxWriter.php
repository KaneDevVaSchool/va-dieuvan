...
class VehicleListXlsxWriter
{
    ...
    private const HEADERS = [
        'STT', 'Biển số xe', 'Loại xe', 'Số chỗ ngồi',
        'Tải trọng (kg)', 'Chủ xe', 'Năm SX', 'Trạng thái', 'Ghi chú',
    ];
    ...
    public function writeTempFile(array $rows, array $meta = []): string
    {
        ...
        $tmpPath = tempnam(sys_get_temp_dir(), 'vehicles_export_');
    ...
    private function buildSheet(Worksheet $ws, array $rows, array $meta): void
    {
        ...
        $ws->setCellValue('A1', 'DANH SÁCH XE');
        ...
        $ws->setCellValue('A3', "Tổng: {$total} xe  ·  Bộ lọc: {$filterSummary}");
        ...
        $widths = [6, 16, 12, 12, 14, 24, 10, 14, 28];
