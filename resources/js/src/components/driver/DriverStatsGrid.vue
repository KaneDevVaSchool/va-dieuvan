...
const props = defineProps({
  ...
  /** Gắn với hero dashboard: cùng khối gradient, viền mint nhẹ */
...
const sectionClass = computed(() =>
  props.variant === 'hero'
    ? 'rounded-2xl border border-[#7fdcc8]/20 bg-[#051615]/80 px-3 py-4 shadow-[inset_0_1px_0_0_rgba(127,220,200,0.14)] backdrop-blur-md sm:px-4'
    : 'rounded-3xl bg-[#0f1816] px-3 py-4 shadow-xl shadow-black/25 sm:px-4',
)
