    ...
    >
        <div class="space-y-3 p-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <details class="group relative shrink-0">
                    ...
                    >
                        ...
                        />
                        <span
                            class="max-w-[6rem] truncate text-xs text-slate-600 dark:text-slate-300 sm:max-w-[9rem]"
                        >
                            {{
                                t(
                                    "trip_detail.coordination.toolbar_funnel_label",
                                )
                            }}
                        </span>
                        <ChevronDownIcon
                    ...
                    >
                        <div
                            class="border-b border-slate-100 pb-1.5 text-xs font-semibold text-slate-500 dark:border-slate-700 dark:text-slate-400"
                        >
                            {{
                                t(
                                    "trip_detail.coordination.toolbar_funnel_applied",
                                )
                            }}
                        </div>
                        <ul
                            class="mt-2 max-h-[min(40vh,200px)] space-y-1.5 overflow-y-auto text-xs text-slate-700 dark:text-slate-300"
                        >
                            <li
                                v-for="(line, idx) in coordinationFunnelLines"
                                :key="'cf-' + idx"
                            >
                                {{ line }}
                            </li>
                            <li
                                v-if="!coordinationFunnelLines.length"
            ...
            >
                ...
                >
                    <span
                        class="shrink-0 text-xs font-semibold text-indigo-800 dark:text-indigo-200"
                    >
                    ...
                    >
                        <span
                            v-if="rescheduling"
                            class="mr-1 inline-block h-2.5 w-2.5 animate-spin rounded-full border border-white/50 border-t-white"
                        />
            ...
            <div
                class="rounded-xl border border-slate-200/80 bg-slate-50/40 p-3 dark:border-slate-700/60 dark:bg-slate-900/40"
            >
                <VehicleCard
            ...
            >
                ...
                <ul
                    class="mt-1.5 max-h-36 space-y-1 overflow-y-auto text-[11px]"
                >
                    <li
            ...
            <div
                class="border-t border-slate-100 pt-2.5 dark:border-slate-700/60"
            >
                <label
