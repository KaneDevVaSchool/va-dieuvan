...
<template>
  ...
  >
    <div class="px-3 py-4 sm:px-5">
      <div
        class="flex flex-col gap-3 md:flex-row md:items-start md:gap-4 lg:gap-5"
      >
    ...
    <div
      v-if="$slots.actions"
      class="mt-auto flex flex-wrap items-center justify-end gap-2 border-t border-slate-100 px-3 py-3 sm:px-5 dark:border-slate-800"
      @click.stop
    >
      <slot name="actions" />
    </div>
