...
<head>
    ...
    <title>Nhắc khởi hành — #{{ $tripTypeLabel }}</title>
</head>
    ...
    <tr>
        <td align="center" style="padding:0 12px;">
            <table role="presentation" width="580" cellspacing="0" cellpadding="0" style="max-width:580px;background-color:#ffffff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
                <tr>
                    <td style="background:#1d4ed8;padding:20px 26px;color:#ffffff;">
                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                            <tr>
                                ...
                                <td align="right" style="vertical-align:middle;">
                                    <span style="font-size:11px;color:#bfdbfe;border:1px solid rgba(191,219,254,0.6);padding:3px 10px;border-radius:10px;">⏱ NHẮC KHỞI HÀNH</span>
                                </td>
                            </tr>
                        </table>
                        <p style="margin:14px 0 4px;font-size:17px;font-weight:600;line-height:1.35;color:#ffffff;">Còn khoảng 15 phút đến giờ xuất phát</p>
                        <p style="margin:0;font-size:13px;line-height:1.5;color:rgba(255,255,255,0.78);">Vui lòng chuẩn bị và kiểm tra xe trước khi khởi hành.</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding:22px 26px;color:#334155;font-size:14px;line-height:1.6;">
                        ...
                        <p style="margin:0 0 16px;color:#475569;">Đây là nhắc nhở tự động về chuyến sắp khởi hành.</p>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="8" role="presentation" style="border-collapse:collapse;margin:0 0 18px;font-size:13px;">
                            ...
                            <tr><td style="padding:8px 0;color:#64748b;">Giờ đón</td><td style="padding:8px 0;color:#1d4ed8;font-weight:700;">{{ $timeLineDepart }}</td></tr>
                        </table>
                        ...
                        <p style="margin:0 0 22px;text-align:center;font-size:12px;"><a href="{{ $detailUrl }}" style="color:#1d4ed8;text-decoration:none;">Hoặc mở liên kết trực tiếp trong trình duyệt của bạn</a></p>
