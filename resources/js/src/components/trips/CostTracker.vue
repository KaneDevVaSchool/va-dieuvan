    ...
    >
        ...
        >
            ...
            >
                ...
                <div
                    v-if="pendingFile"
                    class="flex items-center gap-2 border-t border-slate-200/80 pt-1.5 dark:border-slate-700/80"
                >
                    <div
                        class="flex h-7 w-7 shrink-0 items-center justify-center overflow-hidden rounded border border-slate-200 bg-slate-100 text-[9px] dark:border-slate-600 dark:bg-slate-800"
                    >
                        <img
        ...
        <div
            ...
            class="mt-3 border-t border-slate-100 pt-2.5 dark:border-slate-700"
        >
            <div
            ...
            <div class="mt-1.5 space-y-1.5">
                ...
                >
                    <span
                        class="w-20 shrink-0 font-medium text-slate-700 dark:text-slate-300"
                        >{{ row.label }}</span
                    >
                    <div
                        class="h-1.5 min-w-0 flex-1 overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800"
                    >
                        <div
                ...
                <div
                    class="flex items-center justify-between border-t border-slate-100 pt-1.5 text-xs font-semibold dark:border-slate-700"
                >
