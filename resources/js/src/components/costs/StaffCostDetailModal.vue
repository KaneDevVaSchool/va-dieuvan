  ...
  >
    ...
    <div v-else-if="cost" class="space-y-5">
      ...
      <CostEstimateLegBreakdown
        v-if="cost?.estimate_lines?.length"
        :lines="cost.estimate_lines"
        variant="section"
        test-id="cost-detail-leg-costs"
        row-test-id-prefix="cost-detail-leg-row"
      />
...
import CostEstimateLegBreakdown from './CostEstimateLegBreakdown.vue'
