<template>
  ...
  >
    ...
    <div class="flex flex-wrap items-center justify-between gap-2">
      <h2 class="text-xs font-bold uppercase tracking-wide text-slate-500">{{ t('trip_detail.costs_block.title') }}</h2>
    ...
    <div v-if="breakdown.grand > 0" class="mt-3 border-t border-slate-100 pt-2.5 dark:border-slate-700">
      <div class="text-xs font-bold uppercase tracking-wide text-slate-500">{{ t('trip_detail.costs.breakdown_title') }}</div>
