  ...
  <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
    ...
    <div class="mt-4 grid gap-3">
      ...
      <RouterLink
        ...
        class="group flex min-h-[52px] items-center gap-3 rounded-2xl border border-va-200/80 bg-va-50/60 px-4 py-3 text-left shadow-sm transition hover:border-va-300 hover:bg-va-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-va-800"
      >
        <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-white shadow-sm ring-1 ring-va-200/80">
      ...
      <RouterLink
        ...
        class="group flex min-h-[52px] items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50/80 px-4 py-3 text-left shadow-sm transition hover:border-va-300 hover:bg-va-50/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-va-800"
      >
    ...
    <RouterLink
      ...
      class="mt-4 flex min-h-[44px] items-center justify-center rounded-xl border border-slate-200 bg-slate-50/80 text-sm font-semibold text-va-800 transition hover:border-va-200 hover:bg-va-50/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-va-800"
    >
