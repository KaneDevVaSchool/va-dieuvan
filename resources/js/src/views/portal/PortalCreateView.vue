<template>
    <div
        class="dispatch-wizard portal-create w-full min-w-0 space-y-4 px-4 py-4 text-slate-900 supports-[padding:max(0px)]:pl-[max(1rem,env(safe-area-inset-left))] supports-[padding:max(0px)]:pr-[max(1rem,env(safe-area-inset-right))] sm:px-6 sm:py-5 lg:px-8 lg:py-6"
                ...
                <div v-show="step === 1" class="dw-portal-step2">
                    ...
                    >
                            ...
                            <p v-if="form.targets.length" class="dw-field-hint">
                                {{
                                    t(
                                        "dispatch_wizard.create.targets_selected_one",
                                        { name: form.targets[0] },
                                    )
                                }}
                            </p>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            {{
                                t("dispatch_wizard.create.targets_selected_one", {
                                    name: form.targets[0],
                                })
                            }}
                        </p>
...
import DispatchWizardLiveSummary from "../requests/dispatch-wizard/DispatchWizardLiveSummary.vue";
import DispatchWizardActionBar from "../requests/dispatch-wizard/DispatchWizardActionBar.vue";
