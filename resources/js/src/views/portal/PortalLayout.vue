<template>
  ...
  <div
    class="portal-app h-full min-h-0 overflow-y-auto overscroll-y-contain bg-white pt-[calc(env(safe-area-inset-top,0px)+4.75rem)] text-slate-900 antialiased sm:pt-[calc(env(safe-area-inset-top,0px)+5rem)]"
  >
    <PortalHeader />
    <RouterView />
  </div>
